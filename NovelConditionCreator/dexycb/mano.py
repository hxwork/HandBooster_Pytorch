...
sys.path.append('../')
from dexycb.manopth.manopth.manolayer import ManoLayer


class MANO(object):

    def __init__(self, side, flat_hand_mean=False):
        self.layer = self.get_layer(side, flat_hand_mean)
        self.vertex_num = 778
        ...
        self.joints_name = ('Wrist', 'Thumb_1', 'Thumb_2', 'Thumb_3', 'Thumb_4', 'Index_1', 'Index_2', 'Index_3', 'Index_4', 'Middle_1', 'Middle_2', 'Middle_3', 'Middle_4',
                            'Ring_1', 'Ring_2', 'Ring_3', 'Ring_4', 'Pinky_1', 'Pinky_2', 'Pinky_3', 'Pinly_4')

        self.skeleton = ((0, 1), (0, 5), (0, 9), (0, 13), (0, 17), (1, 2), (2, 3), (3, 4), (5, 6), (6, 7), (7, 8), (9, 10), (10, 11), (11, 12), (13, 14), (14, 15), (15, 16),
                         (17, 18), (18, 19), (19, 20))
    ...
    def get_layer(self, side, flat_hand_mean=False):
        return ManoLayer(mano_root=osp.join('./manopth', 'mano', 'models'), flat_hand_mean=flat_hand_mean, use_pca=False, side=side)  # load right hand MANO model
