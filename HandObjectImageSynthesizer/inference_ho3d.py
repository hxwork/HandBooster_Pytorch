...
from trainer import Tester_HO3D
...
if __name__ == '__main__':
    ...
    hand_recon_model = fetch_hand_recon_model(model_name='mobrecon', model_path='./hand_recon/experiment/ho3d.mobrecon.ori/filter/val_model_best.pth')
