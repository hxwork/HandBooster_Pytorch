...
from hand_recon.common.utils.manopth.manopth.manolayer import ManoLayer
...
class MANO(object):
    ...
    def get_layer(self, side):
        return ManoLayer(mano_root=osp.join("./hand_recon/common/utils/manopth", "mano", "models"), flat_hand_mean=False, use_pca=False, side=side)  # load right hand MANO model
